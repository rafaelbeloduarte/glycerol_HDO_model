...
for i = 1:1:n
  i
  e_x_12P_boot = boot(res_x_12P, n_boot);
  e_x_13P_boot = boot(res_x_13P, n_boot);
  e_x_EG_boot = boot(res_x_EG, n_boot);
  e_x_S_boot = boot(res_x_S, n_boot);
  e_x_I_boot = boot(res_x_I, n_boot);
  e_x_G_boot = boot(res_x_G, n_boot);
  e_x_M_boot = boot(res_x_M, n_boot);
