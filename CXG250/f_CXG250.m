...
function Y = f_CXG250(constante)
  ...
  t_exp = [0 1 2 3 4 5 6];
  x = [0	0	0	0	0.0000705673656836223	0	0
0	0	0.000049194610207348	0.00008038826006635	0.000167626216044625	0.00023443991334025	0.000794833318952318
0	0	0	0	0	0	0.000411275579826642
0.684442205351682	0.684442205351682	0.683663031866356	0.681776781563699	0.679726838611213	0.678165959149904	0.666197523341925
0	0	0	0	0	0	0.000107741005704599
0	0	0.000700825416546395	0.0021718615139465	0.00346159006059108	0.00477848010634989	0.0117368735793406
0	0	0	0	0	0	0];
  x_EG_exp = x(1,:);
  x_12P_exp = x(2,:);
  x_13P_exp = x(3,:);
